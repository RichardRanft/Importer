...
class HelpSite : ISite
{
    ...
    public HelpSite(IContainer actvCntr, IComponent prntCmpnt)
    {
...
class HelpComponent : IComponent
{
    ...
    public HelpComponent(string Title, string Author)
    {
        m_curISBNSite = null;
        Disposed = null;
        m_bookTitle = Title;
    ...
    {
        HelpComponent cmpObj = (HelpComponent)cmp;
